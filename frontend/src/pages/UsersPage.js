        ...
        {loading ? (
          ...
          <>
            <div className="admin-summary">
              <div>
                <span className="admin-summary-kicker">Single admin mode</span>
                <strong>{adminUser ? adminUser.name : 'No admin assigned'}</strong>
                <p>{adminUser ? `${adminUser.email} is the only global admin.` : 'The next signup will become workspace admin.'}</p>
              </div>
